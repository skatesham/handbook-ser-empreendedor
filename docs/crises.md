...
!!! warning "Nem todo problema é crise"
...
??? question "Como saber se é crise ou problema comum?"
...
??? question "E se não soubermos a causa raiz?"
...
??? question "Devo comunicar publicamente?"
    **Depende do impacto:**
...
??? question "Como evitar pânico na equipe?"
...
1. **[Crie template de crise](quadro.md)** no seu quadro
2. **[Defina equipe de crise](painel.md)** na estrutura
3. **[Estabeleça indicadores](indicadores.md)** de prevenção
4. **[Documente aprendizados](retrospectivas.md)** de crises passadas

---

<p align="center">
  <strong>Gestão de Crises</strong> — Transforme problemas em aprendizado 🚨
</p>
